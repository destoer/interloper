...
const char* KEYWORD[][2] =
{
    ...
    {tok_name(token_type::in_t),"token_type::in_t"},
    ...
    {tok_name(token_type::const_assert),"token_type::const_assert"},
    ...
    {tok_name(token_type::cast_ref),"token_type::cast_ref"},
    ...
    {tok_name(token_type::operator_t),"token_type::operator_t"},
    ...
    {tok_name(token_type::type_alias),"token_type::type_alias"},
    {tok_name(token_type::ignore),"token_type::ignore"},
};
