...
ConstRegSpan opcode_reg_span(const Opcode& opcode, RegSpan& reg)
{
    ...
    switch(opcode.group)
    {
        ...
        case op_group::arith_reg_three: return reg_three_reg_span(opcode.arith_reg_three,reg);
        case op_group::shift_imm_three: return imm_three_reg_span(opcode.shift_imm_three,reg);
